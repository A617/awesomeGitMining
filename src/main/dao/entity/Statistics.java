...
/*	private static Statistics instance;
	...
	public static final String[] rank = { "star", "fork", "watchers", "subscribers", "issues", "contributors", "collabotators" };

	public static final String[] company = { "Shopify", "Github", "Google", "Twitter", "Facebook", "Xamarin", "Red Hat",
			"Heroku", "Microsoft", "Mozilla" };

	public static String[] getLanguage() {
		String[] language = { "Ruby", "Python", "Java", "JavaScript", "C", "Perl", "PHP", "C++", "HTML",
				"Shell", "C#", "Prolog", "Scala", "Viml", "CSS", "Go", "Clojure", "CoffeeScript", "Haskell", "Lua",
				"Objective-C", "others" };
		return language;
	}
	...
	public static String[] getCompany() {
		String[] company = { "Shopify", "Github", "Google", "Twitter", "Facebook", "Xamarin", "Red Hat",
				"Heroku", "Microsoft", "Mozilla" };
		return company;
	}
