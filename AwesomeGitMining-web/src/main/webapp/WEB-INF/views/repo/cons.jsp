...
<div class="templatemo-top-nav-container">
    <div class="row">
        ...
        <div class="dropdown navbar-right">
            <%session.setAttribute("backuri","/repo/cons?pager.offset=0");%>
            <%
        ...
        <div class="templatemo-flex-row flex-content-row">
            ...
            <div class="col-2 panel panel-default margin-10">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="contributers">
                        <div class="panel-body">
                            <ul class="dashboard-list">
                                <c:forEach items="${cons }" var="repo">
                                    <li>
                            ...
                            <ul class="pagination  pagination-centered">
                                ${pageUrl}<br>
                                <pg:pager url="/repo/cons" items="${total}">
                                    <li>
                                        <pg:first>
